 ...
 * A SocialUrl object does not belong to any parent object as its use is general in nature,
 ...
 */
class SocialUrl extends grails.plugins.nimble.core.Url{

    static belongsTo = [Feed, SocialMediaAccount, SocialMediaService, Status]
