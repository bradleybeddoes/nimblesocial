<%@ page import="grails.plugins.nimble.social.PhoneType;" %>
...
<div id="currentphonenumbers">
  <g:render template="/templates/nimblesocial/profile/edit/phone_edit_list" contextPath="${pluginContextPath}" model="[user:user]" />
</div>
